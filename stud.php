...
<html lang="en">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <h1 class="text-center"> Data Management HOD Section</h1>
    <p class="text-center">
   ...
   <div class="container text-right">
    <a href="export.php" class="btn btn-warning rounded shadow p-2 m-1  border border-dark">Export Data</a>
    </div> 
      <div class="container">
         <table class="table table-striped" id="myTable">
            ...
            <tbody>
               ...
               <tr>
                  ...
                  <td><button class="btn-info btn m-0"><a href="delete.php?id=<?php echo $row['id'];?>" class="text-white">Delete</a></button></td>
                  <td><button class="btn-info btn"><a href="updated.php?id=<?php echo $row['id'];?>" class="text-white">Update</a></button></td>
               </tr>
               <?php	
                  }
                  ?>
